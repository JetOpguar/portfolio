  ...
  <div class="max-w-7xl m-center pt-1 pb-20">
    <div class="about-me text-center mt-10 md:mt-32">
      ...
      <h4
        ...
        data-aos-duration="500"
      >
      Thank you for taking the time to check out my work. You can sent me a message by using the contact form on my website below. I will do my best to respond to your message as soon as possible!
      </h4>
    </div>
    <div
    ...
    >
      <button class="button dark:text-white dark:border-white w-36">
        <a href="mailto:benchjetro@gmail.com">Say Hi</a>
      </button>
    </div>
  </div>
</template>
